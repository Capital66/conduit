...
def test_webshop():
    ...
    page_2_button = driver.find_element_by_xpath('//*[@id="app"]/div/div[2]/div/div[1]/div[2]/div/div/nav/ul/li[2]/a')
    page_2_button.click()
    time.sleep(3)

    element = driver.find_element_by_xpath('//li[@data-test="page-link-2"]')
    assert element.get_attribute('class') == "page-item active"
